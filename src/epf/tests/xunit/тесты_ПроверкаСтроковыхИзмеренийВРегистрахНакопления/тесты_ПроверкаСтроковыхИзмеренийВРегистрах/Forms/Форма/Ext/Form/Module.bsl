...
Процедура Настройки(КонтекстЯдра, Знач ПутьНастройки)
	...
	// NOTE: пример описания исключения внутри теста, а не во внешнем файле	
	//ИсключенияИзПроверок.Вставить(ВРЕГ("РегистрСведений.МобильныеОтчеты"), ВРЕГ("РегистрСведений.МобильныеОтчеты"));
	// Сообщение об исключении содержит блок Pending/Failed
