...
//
// Параметры:
//  КонтекстЯдраПараметр - xddTestRunner.epf - Обработка, браузер тестов. Находится в каталоге "C:\Program Files\OneScript\lib\add\"
//
&НаКлиенте
Процедура Инициализация(КонтекстЯдраПараметр) Экспорт
	...
	Утверждения 		= КонтекстЯдра.Плагин("БазовыеУтверждения"); // обработка с именем "БазовыеУтверждения.epf", которая находится в каталоге "C:\Program Files\OneScript\lib\add\plugins" 
...
//
// Параметры:
//  НаборТестов			 - ЗагрузчикФайла.epf	 - Внешняя обработка, имеющая программный интерфейс. Находится в каталоге "C:\Program Files\OneScript\lib\add\plugins"
//  КонтекстЯдраПараметр - xddTestRunner.epf	 - Внешняя обработка, браузер тестов. Находится в каталоге "C:\Program Files\OneScript\lib\add\"
//
&НаКлиенте
Процедура ЗаполнитьНаборТестов(НаборТестов, КонтекстЯдраПараметр) Экспорт
	...
	НаборТестов.НачатьГруппу("ДемоПримерГруппыТестов", СтрогийПорядокВыполнения);
	
	ИмяЭкспортногоМетода 	= "ТестДолжен_ПроверитьЧтоФункцияВозвращаетПравильныйРезультат";
	ИмяТеста 				= "Проверить, что функция возвращает правильный результат";
	
	НаборТестов.Добавить(ИмяЭкспортногоМетода, НаборТестов.ПараметрыТеста("ПараметрТеста"), ИмяТеста);
...
//
// Параметры:
//  КонтекстЯдра	 - xddTestRunner.epf - Обработка, браузер тестов. Находится в каталоге "C:\Program Files\OneScript\lib\add\"
//  ПутьНастройки	 - Строка - 
//
&НаКлиенте
...
&НаКлиенте
Процедура ТестДолжен_ПроверитьЧтоФункцияВозвращаетПравильныйРезультат(ПолноеИмяМетаданных) Экспорт
